...
{funcstack.LAMBDA},{hashlib.sha256(cleaned_src.encode('utf-8')).hexdigest()}"
    ...
    def translate_folder(self, folder_path):
        ...
        with open(os.path.abspath(os.path.join(os.path.dirname(__file__), '../examples/black-3-buggy-src.json')),
                  'w') \
                as src_file:
...
if __name__ == "__main__":
    t = Translator("")
    t.translate_folder("/Users/eduardo/Desktop/bugfox-py/BugsInPy/framework/bin/temp/black")
